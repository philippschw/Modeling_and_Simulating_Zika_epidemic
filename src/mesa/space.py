...
class SingleGrid(Grid):
    ...
    def __init__(self, height, width, torus):
        ...
        super(SingleGrid, self).__init__(height, width, torus)
    ...
    def init_agent_to_empty_patch(self, agent):
        """
    ...
    def _place_agent(self, pos, agent):
        if self.is_cell_empty(pos):
            #print (self.empties)
            super(SingleGrid, self)._place_agent(pos, agent)#super()._place_agent(pos, agent)
            self.empties.remove(pos)
            #print ("remove agent from empties")
            #print(self.empties)
        else:
            raise Exception("Cell not empty")

    def _remove_agent(self, pos, agent):
        super(SingleGrid, self)._remove_agent(pos, agent)#super()._remove_agent(pos, agent)
